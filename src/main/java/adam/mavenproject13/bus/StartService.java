...
import adam.mavenproject13.pers.AddressFacade;
import adam.mavenproject13.pers.AdministratorFacade;
import adam.mavenproject13.pers.BasketFacade;
import adam.mavenproject13.pers.BooksFacade;
import adam.mavenproject13.pers.OrdersFacade;
import adam.mavenproject13.pers.PaymentMethodFacade;
...
//        Person p = new Person();
    ...
    public void addPaymentMethod(PaymentMethod pay){
        pay.setId(801L);
        pmf.edit(pay);
    }
    ...
    public void setOrder(Orders o, Basket item){
        of.create(o);
        baf.remove(item);
    }
