...
public class start {
    ...
    private List<Foul> foulsAdded;
    
    public start() {
    }

    //public List<Foul> getFoulsAdded() {
        //List<Foul> foulList = new ArrayList<Foul>();
        //foulList fL = new foulList(foulList, quarter, timeLeft, homeOrAway, Test, player, Position, referee, decision);
        //return foulsAdded;
    //}
