...
//        ss.addFoul(foul);
    ...
    public String getEmptyQuarter() {
        return emptyQuarter;
    }

    public void setEmptyQuarter(String emptyQuarter) {
        this.emptyQuarter = emptyQuarter;
    }
    
    public void checkRequired(){
        if(foul.getQuarter().isEmpty()){
            emptyQuarter = "Enter a quarter";
        }
    }
